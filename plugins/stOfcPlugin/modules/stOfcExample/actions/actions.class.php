...
class stOfcExampleActions extends sfActions
{
	...
	public function executePieChartData()
	{
		...
		$g->title( 'Grafico-Torta Ejemplo', '{font-size:18px; color: #18A6FF}' );
		echo $g->render();
		return sfView::NONE;
	}
	...
	public function executeBarChartData()
	{
		...
		//Creating a stGraph object
		$g = new stGraph();
		$g->title( 'Graffico-Barra Ejemplo', '{font-size: 20px;}' );
		$g->bg_colour = '#E4F5FC';
	...
	public function executeLineChartData()
	{
		...
		// Chart Title
		$g->title( 'Gradico-Linea Ejemplo', '{font-size: 20px;}' );
		$g->bg_colour = '#E4F5FC';
		$g->set_inner_background( '#E3F0FD', '#CBD7E6', 90 );
		$g->x_axis_colour( '#8499A4', '#E4F5FC' );
		$g->y_axis_colour( '#8499A4', '#E4F5FC' );
	...
	public function execute3DBarChartData()
	{
		...
		$g = new stGraph();
		$g->bg_colour = '#E4F5FC';
		$g->title( 'Unos numero de años 2007 y 2008', '{font-size:20px; color: #18A6FF;}' );
